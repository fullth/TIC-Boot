package com.fullth.tic.service.impl;
...
import com.fullth.tic.mapper.MotorTrendMapper;
import com.fullth.tic.service.MotorTrendService;
import com.fullth.tic.service.PropReader;

@Service
public class MotorTrendServiceImpl implements MotorTrendService{

	@Autowired
	PropReader propReader;
	
	@Autowired
	MotorTrendMapper motorTrendMapper; 
	...
	public Map<String, Object> getMotorTrend(String keyword) {
		...
		try {
			...
			apiURL += "?query=" + search + "&display=10";
	...
	@Override
	public List<Motor> selectMotorScrapList() {
		return motorTrendMapper.selectMotorScrapList();
	}

	@Override
	public void insertMotorScrapList(Motor scrapMotor) {
		motorTrendMapper.insertMotorScrapList(scrapMotor);
	}
